...
isolation level read commited. Esto lo logra al asegurarse que el SP solo pueda leer datos que
ya esten committed, osea los datos no existen hasta que el SP haga commit eliminando
la posibilidad de un dirty read*/
